...
[parameters, stderrors, LLF, ht, resids, summary] = garch1(data(:,1),'GARCH','GAUSSIAN',0,0,data(:,2:3),0,0,0,[],options);
...
[parameters, stderrors, LLF, ht, resids, summary] = garch1(data(:,1),'GARCH', 'GAUSSIAN',1,1,0,1,1,0,[],options);
%%
